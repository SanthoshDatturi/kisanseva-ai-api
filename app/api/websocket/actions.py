...
from app.models.chat_session import GeneralChatResponse
...
from app.services.files import VoiceModulation, VoiceName, text_to_speech_url
...
async def text_to_speech_url_handler(user_id: str, language: str, data: dict):
    try:
        ...
        result = await text_to_speech_url(
