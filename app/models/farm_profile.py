...
class FarmProfile(BaseModel):
    ...
    id: str = Field(
        description="UUID of the farm profile", default_factory=lambda: uuid4().hex
    )
    ...
    farm_number: Optional[int] = Field(
        description="Farm number(1, 2,...), generated sequentially be the application.",
        default=None,
    )
