...
class MonoCrop(BaseModel):
    ...
    image_url: Optional[str] = Field(
        default=None,
        description=(
            "URL of an image representing the crop variety, will be added by backend.",
            "In this field for now give the prompt for generating crop image with in close up clearly understandable what crop for farmer and that best for generating the image with AI.",
            "crop name also should be in english for better results.",
        ),
    )
